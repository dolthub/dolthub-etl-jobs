...
def pages_from(input):
    ...
    redirect = False
    title = None
    logging.info('start going through input')
    # bz = bz2.open(input, 'rb')
    # f = io.BufferedReader(bz)
    for line in input:
...
def main():
    ...
    # ignoredTags and discardElements have default values already supplied, if passed in the defaults are overwritten
