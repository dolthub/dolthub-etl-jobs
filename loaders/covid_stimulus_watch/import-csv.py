...
column_map = {
    ...
    'Facility Street Address': 'facility_street_address',
    'Facility Zip Code': 'facility_zip',
    'Facility Congressional District': 'facility_congressional_district',
    'Facility NAICS Code': 'facility_naics_code',
    'PPP Lender': 'ppp_lender',
    'Jobs Retained': 'jobs_retained',
    'Notes': 'notes',
